                ...
                <Card style={{ padding: '20px', height: '14rem', borderRadius: '25px'   }}>
                    <div className="row no-gutters">
                        ...
                        <div className="col-12">
                            <div className="card-block card-left px-2">
                                <Card.Title style={{ paddingTop: "20px" }}>Job Title</Card.Title>
                                <Card.Subtitle style={{ paddingBottom: "10px" }}>Company Name</Card.Subtitle>
                                <Card.Text className="cardText">MM/YY - MM/YY</Card.Text>
                                <Card.Text className="cardText">This is the part where you would explain what responsibilities you had
                                            at your experience. Make sure to talk about skills that employers like to see.
                                </Card.Text>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row no-gutters">
                        <div className="col-12">
                            <div className="card-block px-2">
                                ...
                                <Card.Text className="cardText">MM/YY - MM/YY</Card.Text>
                                <Card.Text className="cardText">This is the part where you would explain what responsibilities you had
                                            at your experience. Make sure to talk about skills that employers like to see.</Card.Text>
                            </div>
                        </div>
